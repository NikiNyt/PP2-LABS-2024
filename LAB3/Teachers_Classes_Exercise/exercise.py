...
rectangle_area = Rectangle(
    ...
    int(input("enter x top left coordinate of rectangle ")),
    int(input("enter y top left coordinate of rectangle "))
)

print("area of your rectangle:", rectangle_area.getArea())

circle_area = Circle(
    int(input("enter radius of circle ")),
    int(input("enter x coordinate of circle's center ")),
    int(input("enter y coordinate of circle's center "))
)
